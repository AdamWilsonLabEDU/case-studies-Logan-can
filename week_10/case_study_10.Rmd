...
#%>%
 lcds2 <- gather(key='month',value='value',-Land_Cover_Type_1_13)%>%
  lcds3 <- mutate(ID=as.numeric(Land_Cover_Type_1_13), month=factor(month,levels=month.name,ordered=TRUE)
